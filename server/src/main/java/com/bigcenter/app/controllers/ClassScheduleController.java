...
public class ClassScheduleController {
    ...
    @GetMapping
    public ResponseEntity<Set<ClassSchedule>> getAllSchedules() {
        return ResponseEntity.ok(classScheduleService.getAllSchedules());
    }

    @GetMapping("/{id}")
    public ResponseEntity<ClassSchedule> getSchedule(@PathVariable int id) {
        return ResponseEntity.ok(classScheduleService.getSchedule(id));
    }

    @PutMapping
    public ResponseEntity<ClassSchedule> updateSchedule(@RequestBody UpdateClassScheduleDTO dto) {
